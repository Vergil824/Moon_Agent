 ...
 * Migrated from moon-agent/lib/cart/cartApi.ts for Taro
 *
 * API Endpoints (relative to TARO_APP_API_BASE):
 * - GET /trade/cart/list - Query cart list
 * - PUT /trade/cart/update-count - Update item quantity
 * - PUT /trade/cart/update-selected - Update selection state
 * - DELETE /trade/cart/delete - Delete cart items
 * - POST /trade/cart/add - Add item to cart
 */

import { get, put, del, post, type ApiResponse } from "@core/api";
 ...
 */
export async function getCartList(): Promise<ApiResponse<AppCartListRespVO>> {
  return get<AppCartListRespVO>("/trade/cart/list", undefined, {
    showLoading: false,
    showError: false,
  });
}
...
export async function updateCartCount(
  ...
  return put<boolean>("/trade/cart/update-count", params, {
    showLoading: false,
    showError: true,
  });
}
...
export async function updateCartSelected(
  ...
  return put<boolean>("/trade/cart/update-selected", params, {
    showLoading: false,
    showError: false,
  });
}
...
export async function deleteCartItems(
  ...
  return del<boolean>(`/trade/cart/delete?ids=${idsParam}`, {
    showLoading: false,
    showError: true,
  });
}
...
export async function addCartItem(
  ...
  return post<number>("/trade/cart/add", params, {
    showLoading: true,
    showError: true,
  });
}
