...
import { AddressSkeleton, AddressEmptyState, AddressListItem } from "@/components/address";
...
export default function AddressListPage() {
  ...
  const handleAddAddress = () => {
    ...
    router.push(`/profile/addresses/new${queryString ? `?${queryString}` : ""}`);
  };
  ...
  const handleEditClick = (address: Address) => {
    ...
    const queryString = params.toString();
    router.push(`/profile/addresses/${address.id}${queryString ? `?${queryString}` : ""}`);
  };
